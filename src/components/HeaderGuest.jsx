  ...
  return (
    <header className="bg-white shadow-md py-4 px-6 flex justify-between items-center">
      ...
      <nav className="space-x-4">
        ...
        <a href="/auth/login" className="text-sm font-semibold text-blue-600 hover:underline">Login</a>
        <a href="/auth/register" className="text-sm font-semibold text-white bg-blue-600 px-4 py-2 rounded hover:bg-blue-700">Register</a>
      </nav>
    </header>
  );
}
